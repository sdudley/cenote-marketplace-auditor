...
import { cloudPricing, cloudPricingResult, dataCenterPricing, dataCenterPricingResult } from './utils/pricingTable';
...
describe('PriceCalculatorService', () => {
    ...
    it('should calculate correct price for 173 users for cloud with monthly billing', () => {
        const result = stripDailyPrice(service.calculateExpectedPrice({
            pricingResult: cloudPricingResult,
            saleDate: '2025-05-01',
            saleType: 'Renewal',
            isSandbox: false,
            hosting: 'Cloud',
    ...
    it('should calculate correct price for Data Center license with 500 users', () => {
        const result = stripDailyPrice(service.calculateExpectedPrice({
            pricingResult: dataCenterPricingResult,
            saleDate: '2025-05-01',
            saleType: 'Renewal',
            isSandbox: false,
            hosting: 'Data Center',
